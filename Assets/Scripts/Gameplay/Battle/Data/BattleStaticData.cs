...
namespace Project.Gameplay.Battle.Data
{
    public static class BattleStaticData
    {
        ...
        public static Dictionary<string, CardCraftConfig> Crafts => _crafts.Value;
        ...
        private static Lazy<Dictionary<string, CardCraftConfig>> _crafts;
        ...
        static BattleStaticData()
        {
            ...
            _crafts = new(() => Resources.LoadAll<CardCraftConfig>("Gameplay/Crafts").ToDictionary(x => x.name, x => x));
